...
class CombinePlatesPostFunctions {
    ...
    public static void setDNATypeOnCMBPlate(Issue curIssue) {
        ...
        if(numTypesFound != 4) {
            ...
            JiraAPIWrapper.setCFValueByName(curIssue, ConfigReader.getCFName("DNA_TYPE"), "ERROR check combine sources")
            return
        }
        ...
        if(matchingKeys.size() == 4) {
            ...
            JiraAPIWrapper.setCFValueByName(curIssue, ConfigReader.getCFName("DNA_TYPE"), dnaTypesMap.get("1"))
        } else {
            ...
            JiraAPIWrapper.setCFValueByName(curIssue, ConfigReader.getCFName("DNA_TYPE"), outDNAType)
        }
    }

...
LOG.debug "Post-function to add DNA plates to the Submission"

PlateAdder plateAdder = new PlateAdder(curIssue, IssueTypeName.SUBMISSION.toString(), "CURRENT_DNA_PLATES_FOR_SUBMISSION")
plateAdder.execute()
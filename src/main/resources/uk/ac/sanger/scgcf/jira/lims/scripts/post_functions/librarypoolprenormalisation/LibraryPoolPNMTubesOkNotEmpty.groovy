...
/**
 * Set the LPL tubes which completed Library Pool Pre-normalisation successfully and are
 * not empty and so can be used again.
 *
...
LOG.debug "Post-function for declaring source LPL tubes that completed pre-normalisation successfully and are not empty"
...
// process the tubes
if(LPLTubeIds != null) {
    LibraryPoolPreNormPostFunctions.processTubesOkNotEmptyForLibraryPoolPreNormalisation(curIssue, LPLTubeIds)
}

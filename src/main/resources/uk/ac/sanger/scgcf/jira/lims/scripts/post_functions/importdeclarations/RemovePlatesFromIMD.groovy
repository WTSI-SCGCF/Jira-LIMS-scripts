 ...
 * from the current Import Declaration issue via a function in {@code PlateRemover}.
...
PlateRemover plateRemover = new PlateRemover(curIssue, WorkflowName.IMPORT_DECLARATIONS.toString(), "GENERIC_REMOVE_PLATES")

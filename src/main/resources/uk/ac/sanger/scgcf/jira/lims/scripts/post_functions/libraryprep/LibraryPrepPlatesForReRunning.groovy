...
/**
 * User selected 1 or more plates as requiring re-running after Normalisation and Nextera library prep.
...
// process the plates
if(ids != null) {
    LibraryPrepPostFunctions.processPlatesForReRunning(curIssue, ids)
}
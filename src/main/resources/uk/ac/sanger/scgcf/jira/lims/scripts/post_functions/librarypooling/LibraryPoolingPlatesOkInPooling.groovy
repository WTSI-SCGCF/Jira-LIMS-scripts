...
/**
 * This post function allows the user to select which source LIB plates have been successfully
 * pooled into tubes.
 *
...
LOG.debug "Post-function for declaring source LIB plates successfully pooled to tubes"
...
// process the plates
if(LIBPlateIds != null) {
    LibraryPoolingPostFunctions.platesOkInPooling(curIssue, LIBPlateIds)
}
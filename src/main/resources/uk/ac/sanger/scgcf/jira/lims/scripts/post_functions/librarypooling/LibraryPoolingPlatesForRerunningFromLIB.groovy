...
/**
 * This post function allows the user to select which source LIB plates need to have library
 * pooling repeated.
 *
...
LOG.debug "Post-function for declaring source LIB plates that need library pooling to be re-run"
...
// process the plates
if(LIBPlateIds != null) {
    LibraryPoolingPostFunctions.platesForReRunningFromLIB(curIssue, LIBPlateIds)
}

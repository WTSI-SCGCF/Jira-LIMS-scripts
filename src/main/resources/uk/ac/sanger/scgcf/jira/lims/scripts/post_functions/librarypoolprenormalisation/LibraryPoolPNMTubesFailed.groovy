...
/**
 * Set the LPL tubes that failed in Library Pool Pre-normalisation and cannot be used again.
 *
...
LOG.debug "Post-function for declaring source LPL tubes that failed pre-normalisation"
...
// process the tubes
if(LPLTubeIds != null) {
    LibraryPoolPreNormPostFunctions.processTubesFailedForLibraryPoolPreNormalisation(curIssue, LPLTubeIds)
}
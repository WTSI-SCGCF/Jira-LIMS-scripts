...
/**
 * Process the PPL tubes that passed QPCR.
 *
...
LOG.debug "Post-function for declaring source PPL tubes that have passed QPCR and are ready for normalisation"
...
// process the tubes
if(PPLIssueIds != null) {
    LibraryPoolQPCRPostFunctions.processTubesPassed(PPLIssueIds)
}
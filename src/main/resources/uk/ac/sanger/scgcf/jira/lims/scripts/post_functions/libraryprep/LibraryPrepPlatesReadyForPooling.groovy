...
/**
 * User selected 1 or more plates as having completed Normalisation and Nextera library prep successfully.
...
LOG.debug "Post-function for plates successfully Normalised and Nextera library prepped into LIB destinations"
...
// process the plates
if(ids != null) {
    LibraryPrepPostFunctions.processPlatesReadyForPooling(curIssue, ids)
}

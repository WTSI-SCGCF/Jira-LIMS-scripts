...
LOG.debug "Attempting to link DNA Quantification Run reagent(s) to current issue"

ReagentLinker reagentLinker = new ReagentLinker(curIssue, "CURRENT_QUANT_REAGENTS")

...
/**
 * Process the PPL tubes that need to re-run QPCR.
 *
...
LOG.debug "Post-function for declaring source PPL tubes that will re-run QPCR"
...
// process the tubes
if(PPLIssueIds != null) {
    LibraryPoolQPCRPostFunctions.processTubesReRun(PPLIssueIds)
}
